...
\node {S}
child{node{X} child{node{a}} child{node{X} child{node{a}} child{node{X} child{node{a}} child{node{X}}}}}
child{node{a}}
child{node{X} child{node{a}} child{node{X} child{node{a}} child{node{X} child{node{a}} child{node{X}}}}}
;
\end{tikzpicture} 
...
\node {S}
child{node{X} child{node{b}} child{node{X} child{node{b}} child{node{X} child{node{b}} child{node{X}}}}}
child{node{a}}
child{node{X} child{node{b}} child{node{X} child{node{b}} child{node{X} child{node{b}} child{node{X}}}}}
;
\end{tikzpicture} 
